...
class StatusOficioPolicy
{
     ...
     */
    public function update(User $user, StatusOficio $statusOficio): bool
    {
        return $user->hasAnyRole(['Administrador', 'Operador']);
    }
     ...
     */
    public function delete(User $user, StatusOficio $statusOficio): bool
    {
